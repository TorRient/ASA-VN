...
def normalize_text(vncorenlp,text,STOP_WORDS,n_min,n_max):
    ...
    replace_list = {
        ...
        '👎': ' nagative ', '😣': ' nagative ','✨': ' positive ', '❣': ' positive ','☀': ' positive ',':D': ' positive ',
        '♥': ' positive ', '🤩': ' positive ', 'like': ' positive ', '💌': ' positive ',
        '🤣': ' positive ', '🖤': ' positive ', '🤤': ' positive ', ':(': ' nagative ', '😢': ' nagative ',':\'(': ' nagative ',
        ...
        '😵': ' nagative ', '😶': ' nagative ', '🙁': ' nagative ','👍🏻': ' positive ',
        '🍤': '', '😬': '', '🔹': '','🙆🏼': '', '🍛': '', '🍗': '','=))': '  positive ','=)))': '  positive ',
        '🚹': '', '🐟': '', '🍮': '','😅': '', '💔': '', '🙋': '','☔':'','✔':'','🤘':'',
        '🔵': '', '👇': '', '😽': '','🍡': '', '🍢': '', '✅': '','▶':'','•':'','♻':'',
        '🍣': '', '🍲': '', '🍜': '','🙀': '', '🌋': '', '🎊': '','ㅁ':'','ㅠㅠ':'',
